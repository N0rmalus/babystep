            ...
            <div className="rounded-xl border bg-white p-4 shadow-sm">
                <div className="space-y-5">
                    ...
                    <div className="space-y-3">
                        ...
                        <Button size="sm" className="w-full"> Ieškoti </Button>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative h-6">
                            ...
                            <input
                                ...
                                className="absolute left-0 right-0 top-0 h-6 w-full cursor-pointer appearance-none bg-transparent
                           [&::-webkit-slider-thumb]:appearance-none
                           [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4
                           [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-tumbleweed-400
                           [&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-tumbleweed-400
                           [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4
                           [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-tumbleweed-400
                           [&::-moz-range-thumb]:border [&::-moz-range-thumb]:border-tumbleweed-400"
                            />
