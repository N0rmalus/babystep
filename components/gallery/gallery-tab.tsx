...
const GalleryTab: React.FC<GalleryTabProps> = ({
    ...
    return (
        <Tab className="relative flex aspect-square cursor-pointer items-center justify-center rounded-lg bg-white border border-gray-200 shadow-sm hover:shadow-md transition">
            {({ selected }) => (
                <div>
